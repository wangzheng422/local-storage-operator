...
bundle:
	./hack/sync_bundle --operator=$(OPERATOR_IMAGE) --diskmaker=$(DISKMAKER_IMAGE) --bundle=$(REGISTRY)local-storage-bundle:$(VERSION) --index=$(REGISTRY)local-storage-index:$(VERSION) bundle
